...
class Imageupload(models.Model):
    ...
    deeplab_file = models.ImageField(upload_to='images/', blank=True)
    mask_file = models.ImageField(upload_to='images/', blank=True)
    trimap_file = models.ImageField(upload_to='images/', blank=True)
